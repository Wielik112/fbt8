...
/* ============================================
   ...
   ============================================ */
// Rozmiary pochodzą z jednego źródła (js/categories.js → window.SIZE_SETS).
const SHOE_SIZES = (window.SIZE_SETS && window.SIZE_SETS.shoe) || [
  '35', '35,5', '36', '36,5', '36 2/3', '37', '37 1/3', '37,5',
  '38', '38,5', '38 2/3', '39', '39 1/3', '39,5', '40', '40,5', '40 2/3',
  '41', '41 1/3', '41,5', '42', '42,5', '42 2/3', '43', '43 1/3', '43,5',
  '44', '44,5', '44 2/3', '45', '45 1/3', '45,5', '46', '46,5', '46 2/3',
  '47', '47 1/3', '47,5', '48', '48,5', '48 2/3',
];
const APPAREL_SIZES = (window.SIZE_SETS && window.SIZE_SETS.apparel) || ['XS', 'S', 'M', 'L', 'XL', 'XXL'];
